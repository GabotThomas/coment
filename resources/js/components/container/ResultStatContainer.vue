...
<template>
    <div class="result-container_stat">
        <h1>Selon les français.es, les stéréotypes hommes-femmes demeurent nombreux :</h1>
        <div class="result-stat first mb-2">
        ...
        <div class="result-stat third mb-2">
            <div class="result-stat_text">
                <h1>73 %</h1>
